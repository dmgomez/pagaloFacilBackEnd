            ...
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold transaccion"><a class="waves-effect waves-cyan"><i class="mdi-action-swap-vert-circle"></i> Transacciones</a></li>
                        <li class="transaccion"><a href="admin_file_list.php" class="waves-effect waves-cyan"><i class="mdi-action-swap-vert-circle"></i> Generar archivo</a></li>
                        <?php
